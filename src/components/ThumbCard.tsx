      ...
      <div className={cn('relative rounded-3xl overflow-hidden border border-white/10 bg-card shadow-soft')}>        
        <div className={cn('aspect-[2/3]')}>          
          ...
          <button
            ...
            className={cn('absolute right-2 top-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-background/70 ring-1 ring-white/10 backdrop-blur-xs transition hover:bg-white/10')}
